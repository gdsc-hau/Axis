    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 h-16 border-b border-zinc-200 dark:border-zinc-800">
          ...
          <div>
            <h2 className="text-sm font-bold text-zinc-900 dark:text-white leading-none">GDG Admin</h2>
            <p className="text-[11px] text-zinc-400 dark:text-zinc-500 mt-0.5">Axis Control Panel</p>
          </div>
        </div>

          ...
          <div className="w-full flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl minecraft-font mb-6 text-center select-none max-w-full px-2 sm:whitespace-nowrap">
              {displayedTitle.split("").map((char, index) => {
                ...
                if (index === 0)
                  colorClass = "text-[#FF5555]"; // G - Minecraft Light Red
                else if (index === 1)
                  colorClass = "text-[#55FF55]"; // D - Minecraft Lime Green
                else if (index === 2)
                  colorClass = "text-[#FFFF55]"; // G - Minecraft Yellow
                else if (index >= 3 && index <= 5)
                  colorClass = "text-[#5555FF]"; // HAU - Minecraft Light Blue
              ...
              <span className="text-blue-500 animate-[pulse_0.8s_infinite] font-light">
                |
              </span>
            </h1>
            ...
            <div className="flex items-center w-full max-w-4xl gap-4 md:gap-6 relative px-1 sm:px-16 justify-center mx-auto">
              ...
              <div className="hidden sm:flex shrink-0 w-12 h-12 rounded-full border border-white/10 items-center justify-center bg-[#07070a] shadow-[0_0_15px_rgba(0,0,0,0.5)] group hover:border-blue-500/50 transition-colors duration-300">
                <span className="text-[11px] font-mono font-bold text-gray-500 group-hover:text-blue-400 transition-colors">
                  &lt;&gt;
                </span>
              </div>
            ...
            {error && (
              <div className="mt-6 relative max-w-sm mx-4 rounded-2xl border border-red-500/20 bg-zinc-900/95 px-6 py-5 text-center shadow-[0_0_30px_rgba(239,68,68,0.08)] backdrop-blur-md">
                <p className="font-mono text-lg font-bold uppercase tracking-[0.2em] text-red-400">
                  System Error
                </p>

                <div className="mt-4 space-y-1 font-mono text-xs tracking-wider">

...
export default function GdgIdCard({ profile, onEject }: GdgIdCardProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full max-w-[360px] sm:max-w-sm mx-auto flex flex-col z-10 relative"
    >
      <div
            ...
            >
              ...
              <div className="flex items-center space-x-2 sm:space-x-3 border-2 border-white p-1.5 sm:p-2">
                <div className="relative w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center shrink-0">
                  ...
                  <Image
                    ...
                    alt="GDG Logo"
                    fill
                    className="animate-[pulse_4s_infinite] object-contain"
                  />
                </div>
                <div className="flex-grow">
                  <h1 className="uppercase font-bold text-[17px] sm:text-2xl leading-[1.1] sm:leading-none tracking-wide text-white">
                    Google Developers Group
                  </h1>
                  <p className="text-[10px] sm:text-sm mt-0.5 sm:mt-1 text-gray-200">
                    On Campus - Holy Angel University
                  </p>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-4 flex-grow">
                  ...
                  <div className="flex">
                    {[...Array(4)].map((_, i) => (
                      <div
                        key={i}
                        className={`w-4 h-4 bg-white ${i % 2 === 0 ? "mt-4" : ""}`}
                      ></div>
                    ))}
                  </div>
                  ...
                  <div className="grid grid-cols-10 gap-0.5 opacity-80 flex-grow max-w-[60px] sm:max-w-[80px]">
                    {[...Array(30)].map((_, i) => (
                      <div
                        key={i}
                        className={`w-1 h-1 sm:w-1.5 sm:h-1.5 ${i % 3 === 0 ? "bg-white" : "bg-gray-400"}`}
                      ></div>
                    ))}
                  </div>
                </div>
                ...
                <div className="text-3xl sm:text-5xl font-bold flex tracking-wider">
                  <span className="text-red-500 glitch-effect" data-text="2">
                    2
                  </span>
                  <span className="text-blue-500 glitch-effect" data-text="6">
                    6
                  </span>
                  <span className="text-white mx-0.5">'</span>
                  <span className="text-green-500 glitch-effect" data-text="2">
                    2
                  </span>
                  <span className="text-yellow-500 glitch-effect" data-text="7">
                    7
                  </span>
                </div>
              </div>
              ...
              <div className="flex flex-col mt-1 sm:mt-2">
                <h2 className="uppercase font-bold text-[19px] sm:text-[28px] leading-none tracking-wide flex justify-between w-full">
                  <span
                    className="text-red-500 glitch-effect"
                    data-text="BUILD."
                  >
                    BUILD.
                  </span>
                  <span
                    className="text-blue-500 glitch-effect"
                    data-text="LEAD."
                  >
                    LEAD.
                  </span>
                  <span
                    className="text-green-500 glitch-effect"
                    data-text="TRANSFORM."
                  >
                    TRANSFORM.
                  </span>
              ...
              <div className="border-2 border-white">
                ...
                <div className="flex justify-between items-center py-1.5 sm:py-2.5 px-3 sm:px-4 border-b-2 border-white bg-white/5">
                  <span className="font-bold text-gray-300 text-xs sm:text-base">
                    GDG_CODE:
                  </span>
                  <span className="font-mono tracking-widest text-white text-sm sm:text-base">
                    {gdgCode}
                  </span>
                </div>
                ...
                <div className="flex justify-between items-center py-1.5 sm:py-2.5 px-3 sm:px-4 border-b-2 border-white">
                  ...
                  <span className="uppercase text-white tracking-wide text-xs sm:text-base max-w-[160px] sm:max-w-none text-right truncate">
                    {profile.fullName}
                  </span>
                </div>
                ...
                <div className="flex justify-between items-center py-1.5 sm:py-2.5 px-3 sm:px-4 border-b-2 border-white bg-white/5">
                  ...
                  <span className="lowercase text-white font-sans text-[10px] sm:text-sm tracking-wide max-w-[160px] sm:max-w-none text-right truncate">
                    {profile.email}
                  </span>
                </div>
                ...
                <div className="flex justify-between items-center py-1.5 sm:py-2.5 px-3 sm:px-4">
                  ...
                  <span className="uppercase text-white tracking-wide text-[10px] sm:text-base max-w-[150px] sm:max-w-none text-right truncate">
                    {profile.program.replace(/ /g, "_")}
                  </span>
                </div>
              </div>
            </div>

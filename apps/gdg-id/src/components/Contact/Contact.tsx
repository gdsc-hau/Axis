...
const quickHelp = [
  {
    ...
    answer:
      "Our community team usually responds within 24-48 hours during weekdays. For urgent matters, try reaching out via our Facebook page.",
  },
  {
    question: "Who do I contact for event partnerships?",
    answer:
      "Please send an email to gdsc.holyangel@gmail.com with the subject line [Partnership Inquiry] and our leads will get back to you.",
  },
  {
    question: "Where can I report platform issues?",
    answer:
      "If you encounter bugs or issues with your Digital ID, please email our support team directly with screenshots.",
  },
];
      ...
      <div className="relative w-full z-10 flex flex-col items-center pt-28 md:pt-32 px-4 pb-20 max-w-6xl mx-auto">
        ...
        <section className="w-full flex flex-col-reverse md:flex-row items-center justify-between gap-12 mb-32 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-pixelated mb-6 text-white leading-tight drop-shadow-md">
              ...
              <span className="text-[#34A853]">GDG-HAU</span>
            </h1>
            <p className="text-gray-400 text-sm sm:text-base md:text-lg max-w-2xl leading-relaxed mb-8">
              We're here to help you build, connect, and grow. Whether you have
              a question, need support, or want to collaborate, don't hesitate
              to reach out!
            </p>
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 font-mono">
              ...
              <a
                href="#faq"
                className="bg-[#34A853]/10 hover:bg-[#34A853]/20 text-[#34A853] border border-[#34A853]/30 text-xs sm:text-sm uppercase tracking-widest px-6 py-3 rounded-xl font-bold transition-all duration-200 flex items-center gap-2 active:scale-95 shadow-[0_0_15px_rgba(52,168,83,0.15)]"
              >
                Quick Help
              </a>
            </div>
        ...
        <section id="methods" className="w-full mb-16 scroll-mt-32">
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 text-center md:text-left bg-gradient-to-r from-transparent via-white/[0.03] to-transparent p-8 rounded-3xl border-y border-white/5">
            ...
            />
            <div>
              <h2 className="text-2xl sm:text-3xl font-pixelated text-white mb-2">
                Gyro is ready to help you connect!
              </h2>
              <p className="text-gray-400 font-mono text-sm">
                Choose your favorite platform below to reach our team.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="w-full mb-32">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {contactMethods.map((method, idx) => (
              ...
              >
                <div
                  className={`w-16 h-16 rounded-2xl ${method.bg} flex items-center justify-center shrink-0 transition-transform duration-300 group-hover:scale-110`}
                >
                  <method.icon
                    size={30}
                ...
                <div className="flex-1">
                  <h3 className="text-white font-bold font-sans text-lg mb-1">
                    {method.title}
                  </h3>
                  ...
                  <div
                    className={`text-xs font-mono font-semibold flex items-center gap-2 ${method.color}`}
                  >
                    {method.label}
                    <ExternalLink
                      size={12}
                ...
                <div
                  className={`absolute -bottom-8 -right-8 w-24 h-24 blur-[40px] rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-500 ${method.bg.replace("/10", "")}`}
                />
              </a>
            ))}
          </div>
        ...
        <section
          id="faq"
          className="w-full mb-32 scroll-mt-32 max-w-4xl mx-auto"
        >
        ...
        <section className="w-full relative bg-gradient-to-b from-[#FBBC05]/10 to-transparent border border-[#FBBC05]/20 rounded-3xl p-10 sm:p-16 text-center overflow-hidden flex flex-col items-center group">
          ...
          <p className="text-gray-300 text-sm sm:text-base max-w-xl mx-auto mb-10 relative z-10">
            Join the conversation, participate in events, and stay updated with
            the latest from GDG on Campus Holy Angel University.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 font-mono relative z-10">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#FBBC05] hover:bg-[#e3aa04] text-black text-xs sm:text-sm uppercase tracking-widest px-8 py-4 rounded-xl font-bold transition-all duration-200 active:scale-95 shadow-[0_0_20px_rgba(251,188,5,0.3)]"
            >
              Join Our Community
            </a>
          </div>

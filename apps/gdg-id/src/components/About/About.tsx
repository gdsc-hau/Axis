...
const features = [
  {
    ...
    desc: "Your personalized GDG-HAU digital identity card.",
  },
  {
    icon: QrCode,
    title: "QR Code Verification",
    desc: "Fast, secure scanning for event check-ins.",
  },
  {
    icon: Calendar,
    title: "Event Registration",
    desc: "Seamlessly access and register for upcoming events.",
  },
  {
    icon: UserCog,
    title: "Profile Management",
    desc: "Update and manage your member information.",
  },
  {
    icon: Users,
    title: "Community Tools",
    desc: "Engage with fellow tech enthusiasts & members.",
  },
  {
    icon: Award,
    title: "Certificate Tracking",
    desc: "View and verify your earned event certificates.",
  },
  {
    icon: ShieldCheck,
    title: "Secure Verification",
    desc: "Advanced identity confirmation system.",
  },
  {
    icon: DoorOpen,
    title: "Access Control",
    desc: "Streamlined entry for exclusive GDG-HAU events.",
  },
];
...
const steps = [
  {
    ...
    desc: "Sign up using your credentials.",
    icon: UserPlus,
    color: "text-[#4285F4]",
  ...
  },
  {
    ...
    desc: "Admins review your membership.",
    icon: Clock,
    color: "text-[#FBBC05]",
    border: "border-[#FBBC05]/30",
  },
  {
    title: "Access Digital ID",
    desc: "Receive your unique member ID.",
    icon: BadgeCheck,
    color: "text-[#34A853]",
  ...
  {
    title: "Join Events",
    desc: "Participate in workshops & more.",
    icon: PartyPopper,
...
const benefits = [
  {
    ...
    desc: "Skip the line with instantaneous QR code scanning at the door.",
    icon: Zap,
  },
  {
    title: "Verified Identity",
    desc: "Trust within the community through admin-verified memberships.",
    icon: ShieldCheck,
  },
  {
    title: "Organized Participation",
    desc: "Keep track of all your attended events in one single place.",
    icon: Calendar,
  },
  {
    title: "Professional Presence",
    desc: "Showcase your involvement with a digital membership portfolio.",
    icon: IdCard,
  },
];
...
const securityFeatures = [
  {
    title: "Data Privacy",
    desc: "Your personal info is strictly managed and never exposed publicly.",
    icon: Lock,
  },
  {
    title: "Admin Controls",
    desc: "Strict role-based access to sensitive member verification data.",
    icon: Database,
  },
  {
    title: "Secure Auth",
    desc: "Industry-standard authentication and secure session management.",
    icon: ShieldCheck,
  },
];
      ...
      <div className="relative w-full z-10 flex flex-col items-center pt-28 md:pt-32 px-4 pb-20 max-w-6xl mx-auto">
        ...
        <section className="w-full flex flex-col-reverse md:flex-row items-center justify-between gap-12 mb-32 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-pixelated mb-6 text-white leading-tight drop-shadow-md">
              About the <span className="text-[#EA4335]">GDG-HAU</span> <br />{" "}
              Digital ID Platform
            </h1>
            <p className="text-gray-400 text-sm sm:text-base md:text-lg max-w-2xl leading-relaxed mb-8">
              A centralized digital identity system designed exclusively for GDG
              on Campus Holy Angel University members. Seamlessly connect,
              verify, and participate.
            </p>
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 font-mono">
              <a
                href="#features"
                className="bg-[#1e1e1f] hover:bg-[#282829] text-white border border-white/10 text-xs sm:text-sm uppercase tracking-widest px-6 py-3 rounded-xl font-bold transition-all duration-200 flex items-center gap-2 active:scale-95 shadow-lg shadow-black/50"
              >
                Explore Features
              </a>
              <Link
                href="/"
                className="bg-[#4285F4]/10 hover:bg-[#4285F4]/20 text-[#4285F4] border border-[#4285F4]/30 text-xs sm:text-sm uppercase tracking-widest px-6 py-3 rounded-xl font-bold transition-all duration-200 flex items-center gap-2 active:scale-95 shadow-[0_0_15px_rgba(66,133,244,0.15)]"
              >
                Get Started
              </Link>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 relative z-10">
            ...
            <div className="w-full md:w-2/3">
              <h2 className="text-3xl sm:text-4xl font-pixelated text-white mb-6 flex items-center gap-3">
                <span className="text-[#EA4335]">{"//"}</span> What is the
                Platform?
              </h2>
              <p className="text-gray-400 text-sm sm:text-base leading-relaxed mb-8">
                The GDG-HAU Digital ID Platform is a comprehensive digital
                identity and member management ecosystem. Designed for students,
                developers, and tech enthusiasts, it provides streamlined access
                to memberships, events, and verification tools all in one
                unified hub.
              </p>
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm font-mono text-gray-300">
                <li className="flex items-center gap-3 bg-white/5 hover:bg-white/10 transition-colors p-3.5 rounded-xl border border-white/5">
                  <div className="w-2 h-2 bg-[#4285F4] rounded-full shadow-[0_0_8px_#4285F4]" />{" "}
                  Digital Membership
                </li>
                <li className="flex items-center gap-3 bg-white/5 hover:bg-white/10 transition-colors p-3.5 rounded-xl border border-white/5">
                  <div className="w-2 h-2 bg-[#EA4335] rounded-full shadow-[0_0_8px_#EA4335]" />{" "}
                  Event Access
                </li>
                <li className="flex items-center gap-3 bg-white/5 hover:bg-white/10 transition-colors p-3.5 rounded-xl border border-white/5">
                  <div className="w-2 h-2 bg-[#FBBC05] rounded-full shadow-[0_0_8px_#FBBC05]" />{" "}
                  Verified Identity
                </li>
                <li className="flex items-center gap-3 bg-white/5 hover:bg-white/10 transition-colors p-3.5 rounded-xl border border-white/5">
                  <div className="w-2 h-2 bg-[#34A853] rounded-full shadow-[0_0_8px_#34A853]" />{" "}
                  Community Hub
                </li>
              </ul>
            </div>
        ...
        <section id="features" className="w-full mb-32 relative scroll-mt-32">
          <div className="text-center mb-16 relative">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-pixelated text-white mb-4">
              Core Features
            </h2>
            <div className="w-16 h-1 bg-[#4285F4] mx-auto rounded-full mb-4 opacity-50" />
            <p className="text-gray-400 font-mono text-xs sm:text-sm uppercase tracking-widest">
            ...
            <div className="absolute right-4 md:right-12 top-0 hidden sm:block opacity-50 hover:opacity-100 transition-opacity duration-300">
              <Image
                src="/assets/images/gyro/gyro_head_icon.png"
                alt="Gyro Head"
                width={60}
                height={60}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, idx) => (
              <div
                key={idx}
                className="group relative bg-[#131314]/80 backdrop-blur-sm border border-white/5 p-6 rounded-2xl hover:border-[#4285F4]/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_30px_-10px_rgba(66,133,244,0.3)]"
              >
                ...
                <h3 className="text-white font-pixelated text-xl mb-2">
                  {feature.title}
                </h3>
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 lg:gap-4 relative z-10">
              {steps.map((step, idx) => (
                ...
                >
                  <div
                    className={`w-16 h-16 rounded-2xl bg-[#0a0a0d] border ${step.border} flex items-center justify-center mb-6 shadow-lg relative group-hover:scale-110 transition-transform duration-300 z-10`}
                  >
                    <step.icon
                      size={28}
                  ...
                  <h3 className="text-white font-pixelated text-lg sm:text-xl mb-2">
                    {step.title}
                  </h3>
        ...
        <section className="w-full mb-32 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
            {benefits.map((benefit, idx) => (
              <div
                key={idx}
                className="flex items-start gap-5 bg-gradient-to-br from-white/[0.03] to-transparent p-6 sm:p-8 rounded-2xl border border-white/5 hover:border-white/10 transition-colors"
              >
                ...
                <div>
                  <h3 className="text-white font-bold font-sans text-base sm:text-lg mb-2">
                    {benefit.title}
                  </h3>
        ...
        <section className="w-full mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {securityFeatures.map((sec, idx) => (
              <div
                key={idx}
                className="bg-[#131314] p-6 rounded-2xl border border-white/5 text-center flex flex-col items-center group hover:bg-[#1a1a1c] transition-colors"
              >
                ...
                <h3 className="text-white font-pixelated text-xl mb-3">
                  {sec.title}
                </h3>
        ...
        <section className="w-full relative bg-gradient-to-b from-[#4285F4]/10 to-transparent border border-[#4285F4]/20 rounded-3xl p-10 sm:p-16 text-center overflow-hidden flex flex-col items-center group">
          ...
          <h2 className="text-3xl sm:text-5xl font-pixelated text-white mb-4 relative z-10">
            Ready to Join GDG-HAU?
          </h2>
          <p className="text-gray-300 text-sm sm:text-base max-w-xl mx-auto mb-10 relative z-10">
            Start your journey with a verified digital identity. Connect with
            peers, attend exclusive events, and elevate your tech career.
          </p>

          <div className="flex flex-wrap items-center justify-center gap-4 font-mono relative z-10">
            <Link
              href="/"
              className="bg-[#4285F4] hover:bg-[#3367d6] text-white text-xs sm:text-sm uppercase tracking-widest px-8 py-4 rounded-xl font-bold transition-all duration-200 active:scale-95 shadow-[0_0_20px_rgba(66,133,244,0.4)]"
            >
              Register Now
            </Link>
            <a
              href="https://gdg.community.dev/gdg-on-campus-holy-angel-university-angeles-philippines/"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-transparent hover:bg-white/5 text-white border border-white/20 text-xs sm:text-sm uppercase tracking-widest px-8 py-4 rounded-xl font-bold transition-all duration-200 active:scale-95"
            >
              Learn More
            </a>
          </div>

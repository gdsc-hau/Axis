      ...
      <header className="absolute top-0 left-0 w-full px-4 md:px-8 py-4 flex items-center justify-between z-50 border-b border-white/5 bg-[#030305]/40 backdrop-blur-md font-mono">
        ...
        <div className="flex items-center gap-4 md:gap-8">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm">
            <a href="#" className="text-gray-400 hover:text-white transition-colors tracking-wide">About</a>
            <a href="#" className="text-gray-400 hover:text-white transition-colors tracking-wide">FAQs</a>
            <a href="#" className="text-gray-400 hover:text-white transition-colors tracking-wide">Contact</a>
            <a href="#" className="text-gray-400 hover:text-white transition-colors tracking-wide">Coming Soon</a>
          </nav>
        ...
        {menuOpen && (
          <div className="absolute top-full left-0 w-full bg-[#030305]/95 backdrop-blur-xl border-b border-white/5 md:hidden flex flex-col p-5 gap-3 animate-in fade-in slide-in-from-top-2 duration-200 z-50 shadow-2xl">
            <a href="#" onClick={() => setMenuOpen(false)} className="text-gray-400 hover:text-white text-sm py-2.5 border-b border-white/5 transition-colors tracking-wide">About</a>
            <a href="#" onClick={() => setMenuOpen(false)} className="text-gray-400 hover:text-white text-sm py-2.5 border-b border-white/5 transition-colors tracking-wide">FAQs</a>
            <a href="#" onClick={() => setMenuOpen(false)} className="text-gray-400 hover:text-white text-sm py-2.5 border-b border-white/5 transition-colors tracking-wide">Contact</a>
            <a href="#" onClick={() => setMenuOpen(false)} className="text-gray-400 hover:text-white text-sm py-2.5 transition-colors tracking-wide">Coming Soon</a>
          </div>
        )}
      </header>
